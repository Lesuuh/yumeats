const Delivery = () => {
  return (
    <div className="w-full max-w-[1520px] bg-white py-16 px-4">
      <h3 className="text-orange-500 font-bold text-2xl text-center ">
        Quick Delivery App
      </h3>
      <div className="max-w-[1140px] mx-auto flex flex-wrap md:grid-cols-2">
        <img
        ...
        <div className="flex flex-col justify-center">
          <p className="text-[#80df9a] font-bold">Get The App</p>
          ...
          <button className="bg-black text-[#80df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3">Get Started</button>
        </div>
      </div>
    </div>
  );
